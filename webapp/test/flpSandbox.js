		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App",
									"targetURL": "#cybcomproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cybcomproject1-display": {
								"semanticObject": "cybcomproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cyb.com.project1",
									"url": sap.ui.require.toUrl("cyb/com/project1")
								}
							}
						}
					}
